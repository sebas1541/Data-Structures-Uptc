...
public class TransactionView extends TransactionPanel {
    ...
    private void initComponents() {
        ...
        JButton addTransactionButton = createButton("Agregar Transacción");
        addTransactionButton.addActionListener(e -> showPanel("AddTransactionPanel"));
        navigationPanel.add(addTransactionButton);

        JButton editTransactionButton = createButton("Ver y Editar");
        ...
        JButton deleteTransactionButton = createButton("Eliminar Transacción");
